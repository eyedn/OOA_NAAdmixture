...
plink_bed_prefix="${plink_bed_dir}/${genetic_map}_${rep}_genome_all"
...
log_msg "running unrelated-only genome KING rep=${rep}"
for pop in "${pops[@]}"; do
    pop_prefix="${genetic_map}_${rep}_genome_${pop}"
...
log_msg "done unrelated-only genome KING rep=${rep}"
