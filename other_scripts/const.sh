...
SIM_FASTSTRUCTURE_DIR="${OUT_DIR}/fastStructure"
KING_DIR="${OUT_DIR}/king"
STATS_DIR="${OUT_DIR}/stats"

# outputs for simulation VCFs downsampled to empirical SNP density
SIMONEKGDOWNSAMPLE_OUT_DIR="${OUT_DIR}OnekgDownsample"
SIMONEKGDOWNSAMPLE_VCF_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/vcfs"
SIMONEKGDOWNSAMPLE_PLINK_BED_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/plink_beds"
SIMONEKGDOWNSAMPLE_POP_INFO_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/pop_info"
SIMONEKGDOWNSAMPLE_ADMIXTURE_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/admixture"
SIMONEKGDOWNSAMPLE_FASTSTRUCTURE_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/fastStructure"
SIMONEKGDOWNSAMPLE_KING_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/king"
SIMONEKGDOWNSAMPLE_STATS_DIR="${SIMONEKGDOWNSAMPLE_OUT_DIR}/stats"
